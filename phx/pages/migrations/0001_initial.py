    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to=pages.models.Feature.get_upload_path)),
                ('component', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='feature', to='pages.Component')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_url', models.URLField(blank=True)),
                ('link_text', models.CharField(blank=True, max_length=200)),
                ('image', models.ImageField(blank=True, help_text='Image will be cropped and resized to 800x400', upload_to=pages.models.ListItem.get_upload_path)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('component', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='list_items', to='pages.Component')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(max_length=200)),
                ('component', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='pages.Component')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Image will be cropped and resized to 400x600', upload_to=pages.models.ProfileMember.get_upload_path)),
                ('profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profile_members', to='pages.Profile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('align', models.CharField(choices=[('imageLeft', 'Image left'), ('imageRight', 'Image right'), ('centre', 'Centre')], max_length=200)),
                ('background', models.CharField(choices=[('light', 'Light'), ('dark', 'Dark'), ('white', 'White')], max_length=200)),
                ('image', models.ImageField(blank=True, upload_to=pages.models.Quote.get_upload_path)),
        ...
        migrations.AddField(
            model_name='listitem',
            name='list_items',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='list_items', to='pages.ListItems'),
        ),
        migrations.AddField(
